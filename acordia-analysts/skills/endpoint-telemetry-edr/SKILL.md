...
description: Reason about what a host sensor captures and by which mechanism — kernel callbacks, ETW, hooks, AMSI, Sysmon — and where it goes blind, when choosing an execution primitive.
metadata:
  acordia:
