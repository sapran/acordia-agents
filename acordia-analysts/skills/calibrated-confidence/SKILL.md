...
description: Attach an honest confidence level to a judgement on a stable scale, separating the estimate from its strength and resolvable uncertainty from irreducible, when someone will act on it.
metadata:
  acordia:
