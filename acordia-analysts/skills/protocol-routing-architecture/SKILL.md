...
description: Reconstruct the target network's shape from device configs, routing tables, firewall rules and VPNs — L2/L3 topology, VLANs, chokepoints — before planning movement.
metadata:
  acordia:
