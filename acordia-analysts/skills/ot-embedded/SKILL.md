---
name: ot-embedded
description: Analyse an industrial or embedded target on its own terms — controllers, buses, Modbus, DNP3, S7 — where downtime is physical, when the target crosses from IT into ICS or SCADA.
metadata:
  acordia:
