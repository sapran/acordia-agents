...
description: Compose a bottom-line-up-front product — judgement, action, confidence, gaps, a dated ask — when a read must be handed to a decision-maker and acted on without reconstructing it.
metadata:
  acordia:
