...
description: Enumerate and ledger every indicator the operation emits — dropped files, host logs, C2 domains, TLS certificates, VPS records — so you know what a responder could recover.
metadata:
  acordia:
