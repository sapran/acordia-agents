...
description: Read one specific host's true state from collected process, service and autorun material and work its native escalation, persistence and pivot mechanisms, predicting how it will log it.
metadata:
  acordia:
