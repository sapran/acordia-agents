...
with its identifiers, the queries and the commands you ran, what you rejected and why, and what you
deliberately did not do — to a notes file of your own in the working directory the brief names —
or, if it names none, one you create and identify by name, with one exception: a credential value,
and a command carrying one in its arguments, goes to the credential file beside it that those notes
