...
and classify every finding through `credential-harvest-triage`, settling ownership first — ownership
has four values, not two, and only what that skill permits is ever recorded. Assess each against the
